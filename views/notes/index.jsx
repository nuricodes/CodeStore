              ...
              <div className="notes">
                ...
                <div id="note-nav">
                  <form action={`/notes/${note._id}?_method=DELETE`} method="POST" className="delete" >
                    <input type="image" src="https://i.imgur.com/pOghxL9.png" border="0" alt="Submit" className="delete" />
                  </form>
                  <form action={`/notes/edit/${note._id}`} method="GET" className="edit">
                    <input type="image" src="https://i.imgur.com/RLztcXf.png" height="30px" border="0" alt="Submit" className="edit" />
                  </form>
                </div>
                {note.note}
              </div>
